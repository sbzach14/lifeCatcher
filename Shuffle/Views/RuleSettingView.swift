...
struct RuleSettingView: View {
    ...
    var body: some View {
        VStack
        {
            ...
            VStack {
                ...
                if(setting == 2)
                {
                    ...
                    HStack
                    {
                        ...
                        .background(
                            NavigationLink(
                                destination: RankRulesView(rankRules: $rankRules, selectedRuleIndex: selectedRuleIndex),
            ...
            .background(
                NavigationLink(
                    destination: MainContentView(ruleIndex: selectedRuleIndex, args : [
                    ...
                    ], rankRules : getCheckedIndexes(rankRules: rankRules)),
...
func getCheckedIndexes(rankRules: [RankRulesSate]) -> [Int] {
