...
struct JiaJiaBaoGameRuleSettingView: View {
    ...
    var body: some View {
        VStack
        {
            let selectedRule = GameManager.gameRules[8] as! JiaJiaBaoGameRule
        ...
        }.navigationTitle("佳佳宝规则设置").background(Image("bg").resizable().scaledToFill())
    }
...
struct JiaJiaBaoGameRuleSettingView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        JiaJiaBaoGameRuleSettingView(args: args, suitRules: suitRules, rankRules: rankRules)
    }
}
