...
struct CardNineGameRuleSettingView: View {
    ...
    var body: some View {
        ...
        }.navigationTitle("牌九规则设置").background(Image("bg").resizable().scaledToFill())
    }
...
struct CardNineGameRuleSettingView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        CardNineGameRuleSettingView(args: args, suitRules: suitRules, rankRules: rankRules)
    }
}
