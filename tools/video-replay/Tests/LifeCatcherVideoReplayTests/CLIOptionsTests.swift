...
final class CLIOptionsTests: XCTestCase {
    ...
    func testHorizontalShuffleUsesTexasModelsWithoutChangingNormalModes() {
        XCTAssertEqual(ModelRunner.classifierName(mode: .horizontalShuffle, orientation: .horizontal), "cls_20260917_texas")
        XCTAssertEqual(ModelRunner.classifierName(mode: .horizontalShuffle, orientation: .vertical), "cls_20260917_texas")
