...
class NPFiveStatisticRule : Rule{
...
class NPFiveStatistic{
    ...
    static func calWinners(diyDealStatus:[[Bool]], diyDealNum:[Int], FeatureList: [SingleFeature], args: [Int], rankRules: [Int], suitRules: [Int]) -> ([StatisticReturnRCInfo],[Int]) {
        ...
        for i in 0..<rcNum {
            (allPlaySingleFeatures[i].evaluateFlag,allPlaySingleFeatures[i].singlefeatureType, allPlaySingleFeatures[i].isPair) = NPFiveStatisticHandEvaluator(
                rankRules: rankRules,
                suitRules: suitRules
        ...
        if leftSingleFeatures.count < NPFiveStatistic.getMinSingleFeatureNum(rcNum: rcNum,handNum: handNum, communityNum: communityNum, dealType: dealType, diyDealNum: diyDealNum, diyDealStatus: diyDealStatus){
            leftSingleFeatures = []
        }
...
class NPFiveStatisticHandEvaluator{
    var rankRules: [Int]
    var suitRules: [Int]
    ...
    class NPFiveSingleFeature{
        ...
        init(singlefeature: SingleFeature, redspecialfeatureValueRange: Int, blackspecialfeatureValueRange: Int, KValueRange: Int, QValueRange: Int, JValueRange: Int){
            let rule = ClassifierSettingArgs.targetSetting[6] as! NPFiveStatisticRule
            //Rank Initialization
